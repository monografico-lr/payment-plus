  ...
  section#home-section
    ...
    .row.home-options-container
      .col-md-8.hidden-xs.shortcuts-container
          .col-sm-4.shortcut#caller-new-client(data-toggle="modal", data-target="#client-modal")
              i.material-icons person_add
              p.section-title Nuevo Cliente

          .col-sm-4.shortcut(data-toggle="modal", @click="sendTo('/nuevo_contrato')")
              i.material-icons library_books
              p.section-title Nuevo Contrato

          .col-sm-4.shortcut(data-toggle="modal", data-target="#search-client-modal")
              i.material-icons monetization_on
              p.section-title Registrar Pago
          .col-sm-4.shortcut#desk-cash-caller(@click="sendTo('/cierre')")
