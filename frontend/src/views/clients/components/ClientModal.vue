                ...
                form
                  .row
                    ...
                    .form-group
                      ...
                      textarea(name="", class="form-control", id="client-direction-details", tabindex="8", cols="30", rows="5", v-model="store.client.detalles_direccion")
                  ...
                  .row
                    ...
                    .col-md-6
                      ...
                      .form-group
                        ...
                        input(type="tel", class="form-control", id="client-job-telephone", v-model="store.client.telefono_trabajo")
