      ...
      #client-table-container
        .searcher-container.main-toolbar#client-toolbar
          .input-group.search
            ...
            input.form-control.searcher(type="text" placeholder="Busque cliente por cedula, nombre, apellidos o id", v-model.lazy="search")
          .pull-right
        ...
        CustomTable(ids="client-table", :parentId="parentId", :data="clients", :cols="cols", :toolbar="toolbar", :options="tableOptions", :search="search")
  ...
  methods: {
    ...
    deleteClient() {
      ...
      function sendDelete(id) {
        self.$http
          .post('clients/delete', self.getDataForm({ id }))
          .then(res => {
    ...
    updateState(id, state) {
      ...
      this.$http
        .post('clients/update_row', this.getDataForm(form))
        .then(res => {
          this.getClients();
